...
ALL_OBJS := bin/kernel_entry.o bin/kernel_init.okernel bin/basic_io.okernel bin/basic_mem_util.okernel bin/zio.olib bin/zmem.olib bin/zstring.olib
...
$(BIN_DIR)/%.okernel: kernel/%.cpp
	$(CC) -Os -Iinclude -ffreestanding -nostdlib -fno-builtin -fno-rtti -fno-exceptions -m32 -std=c++20 -c -o $@ $^
